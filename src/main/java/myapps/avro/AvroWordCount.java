...
public class AvroWordCount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6106515382569939865L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroWordCount\",\"namespace\":\"myapps.avro\",\"fields\":[{\"name\":\"word\",\"type\":\"string\"},{\"name\":\"wordcount\",\"type\":\"int\"}]}");
   ...
   */
  public static myapps.avro.AvroWordCount.Builder newBuilder() {
    return new myapps.avro.AvroWordCount.Builder();
  }
   ...
   * @return A new AvroWordCount RecordBuilder
   */
  public static myapps.avro.AvroWordCount.Builder newBuilder(myapps.avro.AvroWordCount.Builder other) {
    if (other == null) {
      return new myapps.avro.AvroWordCount.Builder();
    } else {
      return new myapps.avro.AvroWordCount.Builder(other);
    }
  }
   ...
   * @return A new AvroWordCount RecordBuilder
   */
  public static myapps.avro.AvroWordCount.Builder newBuilder(myapps.avro.AvroWordCount other) {
    if (other == null) {
      return new myapps.avro.AvroWordCount.Builder();
    } else {
      return new myapps.avro.AvroWordCount.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroWordCount>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(myapps.avro.AvroWordCount.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(myapps.avro.AvroWordCount other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.word)) {
        this.word = data().deepCopy(fields()[0].schema(), other.word);
    ...
    /**
      ...
      * @return This builder.
      */
    public myapps.avro.AvroWordCount.Builder setWord(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public myapps.avro.AvroWordCount.Builder clearWord() {
      word = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public myapps.avro.AvroWordCount.Builder setWordcount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public myapps.avro.AvroWordCount.Builder clearWordcount() {
